...
You can check both against your own birthday with the [enrollment window checker](/tools/enrollment-timeline/) — it does the arithmetic, including the born-on-the-first rule.
...
And if it has already passed and you are reading this with a sinking feeling: it is almost always fixable. Later than ideal is not the same as too late, and the General Enrollment Period exists for exactly this. [Call and let us work out where you actually stand](/contact/) rather than guessing.
